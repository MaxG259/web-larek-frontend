...
- **Form** — форма для ввода данных заказа и контактов.
- **Page** — управляет отображением всех компонентов на странице.

## Взаимодействие компонентов

- Все компоненты общаются через события (EventEmitter).
- Presenter слушает события от View, обновляет Model и сообщает View об изменениях.
